...
namespace DataAccess.Migrations
{
    ...
    [Migration("20251102044644_AddRefreshTokenTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Models.Address", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Address__3213E83F27608D32");
            ...
            modelBuilder.Entity("DataAccess.Models.Bid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Bid__3213E83FC9D08D72");
            ...
            modelBuilder.Entity("DataAccess.Models.Category", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Category__3213E83F0B4739BA");

                    b.ToTable("Category", (string)null);
                });

            modelBuilder.Entity("DataAccess.Models.Coupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Coupon__3213E83F0BE8F004");
            ...
            modelBuilder.Entity("DataAccess.Models.Dispute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Dispute__3213E83FF4900E19");
            ...
            modelBuilder.Entity("DataAccess.Models.Feedback", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Feedback__3213E83FF8760A3D");
            ...
            modelBuilder.Entity("DataAccess.Models.Inventory", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Inventor__3213E83F6F0E9151");
            ...
            modelBuilder.Entity("DataAccess.Models.Message", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Message__3213E83F0726D512");
            ...
            modelBuilder.Entity("DataAccess.Models.OrderItem", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__OrderIte__3213E83FBE7C2212");
            ...
            modelBuilder.Entity("DataAccess.Models.OrderTable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("PK__OrderTab__3213E83F734776CC");
            ...
            modelBuilder.Entity("DataAccess.Models.Payment", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Payment__3213E83F8FC8E39C");
            ...
            modelBuilder.Entity("DataAccess.Models.Product", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Product__3213E83F7CE3A399");
            ...
            modelBuilder.Entity("DataAccess.Models.ReturnRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("PK__ReturnRe__3213E83F0B7A6742");
            ...
            modelBuilder.Entity("DataAccess.Models.Review", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Review__3213E83F3E1C00E4");
            ...
            modelBuilder.Entity("DataAccess.Models.ShippingInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Shipping__3213E83F7687C746");
            ...
            modelBuilder.Entity("DataAccess.Models.Store", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Store__3213E83F8C8E2F03");
            ...
            modelBuilder.Entity("DataAccess.Models.User", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__User__3213E83FEFB16BFF");

                    b.HasIndex(new[] { "Email" }, "UQ__User__AB6E616433C661D8")
                        .IsUnique()
            ...
            modelBuilder.Entity("DataAccess.Models.Bid", b =>
                {
                    b.HasOne("DataAccess.Models.User", "Bidder")
                        .WithMany("Bids")
            ...
            modelBuilder.Entity("DataAccess.Models.Dispute", b =>
                {
                    b.HasOne("DataAccess.Models.OrderTable", "Order")
                        .WithMany("Disputes")
                        .HasForeignKey("OrderId")
                        .HasConstraintName("FK__Dispute__orderId__5629CD9C");

                    b.HasOne("DataAccess.Models.User", "RaisedByNavigation")
                        .WithMany("Disputes")
